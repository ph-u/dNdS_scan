...
RUN apt-get install debian-archive-keyring && apt-get update && apt-get -y install wget ncbi-blast+ libxml2-dev libcurl4-openssl-dev libssl-dev liblapack-dev libblas-dev
